...
def input_check():
    ...
    if x=="quidditch" or x=="qbr" or x=="gymnast":
        ...
        input_check()
#quidditch function
#calculates goals/ if snitch was caught
#inputs: goals, snitch
#outputs: score
def quidditch_calc():
    try:
...
#QBR function
#INPUTS: completions,interceptions,passing yards, touchdown passes
#OUTPUTS: X+ formula
def qbr_calc():
    try:
...
#Main function
#QUIDDITCH, QBR, GYMNASTICS SCORES
def main():
